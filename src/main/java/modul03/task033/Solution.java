...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("LN=  " + student2.getLastName() + "; CourseTaken= " +

//--------------------?????????????
                        student2.getCoursesTaken()[0].getName()
//-------------------??????????????
        );
        ...
        System.out.println("LN=  " + collegeStudent2.getLastName() + "; CourseTaken= " + collegeStudent2.getCoursesTaken());
