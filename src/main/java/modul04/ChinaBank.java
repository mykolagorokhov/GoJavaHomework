...
//            10%, если EUR и до 1000 и 11%, если EUR и больше 1000
    ...
    public static final int WITHDRAWALLIMIT_USD = 100;
    public static final int WITHDRAWALLIMIT_EUR = 150;

    public static final int FUNDINGLIMIT_USD = 10000;
    public static final int FUNDINGLIMIT_EUR = 5000;

    public static final int MONTHLYRATE_USD = 1;
    public static final int MONTHLYRATE_EUR = 0;

    public static final int COMISSION_MIN_USD = 3;
    public static final int COMISSION_MAX_USD = 5;

    public static final int COMISSION_MIN_EUR = 10;
    public static final int COMISSION_MAX_EUR = 11;
